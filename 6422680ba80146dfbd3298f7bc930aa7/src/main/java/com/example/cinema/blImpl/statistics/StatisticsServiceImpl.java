...
public class StatisticsServiceImpl implements StatisticsService {
    ...
    public ResponseVO getPopularMovies(int days, int movieNum) {
        try {
            ...
            return ResponseVO.buildSuccess(movieRecentBoxOfficeList2MovieRecentBoxOfficeVOList(statisticsMapper.selectMovieRecentBoxOffice(startDate, today, movieNum)));
        } catch (Exception e) {
            e.printStackTrace();
            return ResponseVO.buildFailure("失败");
        }
    ...
    private List<MovieRecentBoxOfficeVO> movieRecentBoxOfficeList2MovieRecentBoxOfficeVOList(List<MovieRecentBoxOffice> movieRecentBoxOfficeList){
        List<MovieRecentBoxOfficeVO> movieRecentBoxOfficeVOList = new ArrayList<>();
        for(MovieRecentBoxOffice movieRecentBoxOffice : movieRecentBoxOfficeList){
            movieRecentBoxOfficeVOList.add(new MovieRecentBoxOfficeVO(movieRecentBoxOffice));
        }
        return movieRecentBoxOfficeVOList;
    }
    ...
    private List<MoviePlacingRateVO> moviePlacingRateList2MoviePlacingRateVOList(List<MoviePlacingRate> moviePlacingRateList){
        ...
        for(MoviePlacingRate moviePlacingRate:moviePlacingRateList){
            Movie temp=movieService.getMovieById(moviePlacingRate.getMovieId());
            moviePlacingRateVOList.add(moviePlacingRate.getVO(temp));
        }
